...
public class TopologicalSort
{
    ...
    public  void toplogicalSort(Node node)
    {
        ...
        for (int i = 0; i < neighbours.size(); i++) {
            ...
            //System.out.println(node.data + " " + node.visited);
            if(n!=null && !n.visited)
            {
                toplogicalSort(n);
                n.visited=true;
    ...
    public static void main(String arg[])
    {
        ...
        System.out.println("Topological Sorting Order from middle:");
        topological.toplogicalSort(node30);

        // Print contents of stack
        Stack<Node> resultStack=topological.stack;

        // Print contents of stack
        resultStack=topological.stack;
