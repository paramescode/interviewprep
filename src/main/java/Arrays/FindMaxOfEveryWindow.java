...
public class FindMaxOfEveryWindow {
    ...
    // this is much better :  https://leetcode.com/problems/sliding-window-maximum/discuss/65884/Java-O(n)-solution-using-deque-with-explanation
    public static List<Integer> usingDQ(int[] arr, int k){
        ...
        for (i = 0; i < k; ++i) {
            ...
            // Add index of current element at rear of queue
            Qi.addLast(i);
        }
        ...
        for (; i < arr.length; ++i) {
            ...
            //for ex, 20, 15, 13 and k = 3 then you can remove 20 which is at 0th position...
    ...
    public static void main(String[] args) {
        ...
        System.out.println();
        res = usingDQ(new int[]{5,7,9,10,11,24}, 3);
        res.stream().forEach(x-> System.out.print(x + " "));
    }
}
